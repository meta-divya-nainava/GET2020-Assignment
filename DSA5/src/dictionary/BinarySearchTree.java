...
public class BinarySearchTree implements Dictionary{
	 Node root;
		 ...
		 * @throws Exception 
		 */
		public BinarySearchTree(JSONObject object) throws Exception {
			this.root = null;
		 ...
		 * @throws Exception 
		   */
			...
			public void addKeyValuePair(String key, String value) throws Exception {
		       ...
		       if(this.getValueAtKey(key)!=null)
		       {
		   ...
		   */
			@Override
			public void deleteKeyValuePair(String key) throws Exception {
				// if key is empty
